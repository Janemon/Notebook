...
<div id="now">
<p>
请输入内容，<input name="go" type="submit" id="go" onclick="" value="马上生成" />
...
<div class="clear"></div>
<div id="footer">&copy; 2010-2012 www.Ali727.com V1.1 <a href="http://www.ali727.com/files/code-v1.1.zip" target="_blank">下载</a></div>
